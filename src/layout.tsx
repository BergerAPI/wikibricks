...
// log the current contents of the pwd
console.log("Current working directory:", process.cwd());
// contents of the cwd - check if public directory exists
const publicDir =
...
if (fs.existsSync(publicDir)) {
  console.log(`Contents of ${publicDir}:`);
...
const getStyles = () => {
  const prodPath = "/app/dist/public/styles.css";
  const devPath = "/app/public/styles.css";

  if (process.env.NODE_ENV === "production") {
    if (fs.existsSync(prodPath)) {
      return fs.readFileSync(prodPath, "utf-8");
    } else {
      console.error(`Production CSS file not found: ${prodPath}`);
    ...
    if (fs.existsSync(devPath)) {
      ...
      console.error(`Development CSS file not found: ${devPath}`);
      return "/* CSS file not found */";
    }
  }
};
